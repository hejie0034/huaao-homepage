...
const domesticPartners=['广东开放大学','国家教育行政学院','北京大学','华中科技大学','哈尔滨工业大学','北京理工大学','四川大学','北京师范大学','宁夏大学','河北工业大学','中南财经政法大学','北京科技大学','重庆大学','华南理工大学','天津大学','江西师范大学','赣南师范大学','江西陶瓷工艺美术职业技术学院','宜春幼儿师范高等专科学校','江西工业工程职业技术学院','温州医科大学','湖南农业大学','云南艺术学院','天津体育学院','福建师范大学','福建农林大学','东莞理工学院','山东理工大学','湖北大学','安徽农业大学','安徽工程大学','北京开放大学','浙江树人学院','联合国教科文组织职业技术教育数字化教席','武汉学院','广州开放大学','吉林交通职业技术学院','岳阳职业技术学院','武汉铁路职业技术学院','广东生态工程职业学院','青海职业技术大学','深圳职业技术大学','湖北交通职业技术学院','湖北三峡职业技术学院','武汉职业技术大学','襄阳职业技术学院','云南能源职业技术学院','成都职业技术学院','成都轻工职业技术大学','成都航空职业技术大学'];
const domesticPartnerFiles=[...Array.from({length:19},(_,index)=>index+1),...Array.from({length:18},(_,index)=>index+21),...Array.from({length:13},(_,index)=>index+40)];
...
domesticPartners.forEach((name,index)=>{const card=document.createElement('figure');card.className='domestic-partner-card';const image=document.createElement('img');const fileNumber=domesticPartnerFiles[index];const number=String(fileNumber).padStart(2,'0');image.src=`assets/partners/domestic-hd/domestic-${number}.${fileNumber===2?'jpg':'png'}`;image.alt=`${name}标志`;image.loading=index<10?'eager':'lazy';image.decoding='async';const caption=document.createElement('figcaption');caption.textContent=name;const description=document.createElement('p');description.textContent=domesticPartnerDescriptions[name];card.append(image,caption,description);domesticBoard.appendChild(card)})}
